...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠉⠉⠉⠉⠉⠉⠛⠛⠛⠛⠛⠛⠋⠉⠉⠉⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
        ...
        keys = {
          ...
          { icon = '󱇧 ', key = 'r', desc = 'Recent Files', action = ':lua Snacks.dashboard.pick("oldfiles")' },
      ...
      sections = {
        ...
        --  pane = 1,
        --  section = 'terminal',
        --  cmd = 'chafa ~/Pictures/misc/neovim-kawaii.png --format symbols --symbols sextant --size 60x17 sleep 0.1',
        --  height = 17,
        --  padding = 1,
        --},
        {
    ...
    image = {
      ...
      formats = {'png', 'jpg', 'jpeg', 'gif', 'bmp', 'webp', 'tiff', 'heic',
        'avif', 'mp4', 'mov', 'avi', 'mkv', 'webm', 'pdf', 'icns', },
      force = false,
      doc = {
        inline = true,
        float = true,
